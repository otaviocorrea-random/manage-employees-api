...
const employee: Employee = new Employee({id: "703d2d63-a4ff-4121-af79-123a76cf0f52", name: "Otavio Corrêa P. Silva", cpf: "98860939003", address: "Igrejinha/RS" });
...
describe('AppController', () => {
  ...
  describe('index', () => {
    ...
    //TODO TESTAR ID, NAME, CPF, ADDRESS
    it('shold return a employees list entity', async () => {
      const result = await employeeController.index();
      expect(result).not.toEqual('ERROU')
    });
  })
});
